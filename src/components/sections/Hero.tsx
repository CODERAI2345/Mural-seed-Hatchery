      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-white text-center">
        <div className={`transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            Premium Quality <span className="text-teal-400">Fish Seeds</span> for Your Success
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-gray-200">
            Trusted by thousands of fish farmers across India for healthy, high-yield fish seeds and expert support.
          </p>
